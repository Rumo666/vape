...
public class Cereal_Trip extends AppCompatActivity {
    public static boolean ShowAdInOnLogin = true;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cereal__trip);
        getSupportActionBar().setTitle("Cereal Trip");
        ...
        Appodeal.setInterstitialCallbacks(new InterstitialCallbacks() {
            ...
            public void onInterstitialLoaded(boolean isPrecache) {
                if (Cereal_Trip.ShowAdInOnLogin){
                    Appodeal.show(Cereal_Trip.this, Appodeal.INTERSTITIAL);
                    Cereal_Trip.ShowAdInOnLogin = false;
                }
