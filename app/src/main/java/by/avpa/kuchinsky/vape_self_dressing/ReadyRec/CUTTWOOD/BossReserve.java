...
public class BossReserve extends AppCompatActivity {
    public static boolean ShowAdInOnLogin = true;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boss_reserve);
        getSupportActionBar().setTitle("Boss Reserve");
        ...
        Appodeal.setInterstitialCallbacks(new InterstitialCallbacks() {
            ...
            public void onInterstitialLoaded(boolean isPrecache) {
                if (BossReserve.ShowAdInOnLogin){
                    Appodeal.show(BossReserve.this, Appodeal.INTERSTITIAL);
                    BossReserve.ShowAdInOnLogin = false;
                }
