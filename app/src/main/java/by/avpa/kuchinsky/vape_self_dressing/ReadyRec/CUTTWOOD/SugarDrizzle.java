...
public class SugarDrizzle extends AppCompatActivity {
    public static boolean ShowAdInOnLogin = true;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sugar_drizzle);
        getSupportActionBar().setTitle("Sugar Drizzle");
        ...
        Appodeal.setInterstitialCallbacks(new InterstitialCallbacks() {
            ...
            public void onInterstitialLoaded(boolean isPrecache) {
                if (SugarDrizzle.ShowAdInOnLogin){
                    Appodeal.show(SugarDrizzle.this, Appodeal.INTERSTITIAL);
                    SugarDrizzle.ShowAdInOnLogin = false;
                }
