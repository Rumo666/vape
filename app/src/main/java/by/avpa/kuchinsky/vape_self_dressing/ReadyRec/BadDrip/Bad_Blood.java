...
public class Bad_Blood extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bad__blood);
        getSupportActionBar().setTitle("Bad Blood");
        ...
        Appodeal.setBannerCallbacks(new BannerCallbacks() {
            ...
            public void onBannerLoaded(int height, boolean isPrecache) {
                ...
                if(Appodeal.isLoaded(Appodeal.BANNER)){
                    Appodeal.show(Bad_Blood.this, Appodeal.BANNER_BOTTOM);}
            }
            @Override
            ...
            public void onBannerClicked() {
                Appodeal.hide(Bad_Blood.this, Appodeal.BANNER);
            }
        });
    }
}
