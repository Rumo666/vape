...
public class CosmicFogKryptonite extends AppCompatActivity {
    public static boolean ShowAdInOnLogin = true;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cosmic_fog_kryptonite);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("COSMIG FOG - Kryptonite");
        ...
        Appodeal.setInterstitialCallbacks(new InterstitialCallbacks() {
            ...
            public void onInterstitialLoaded(boolean isPrecache) {
                if (CosmicFogKryptonite.ShowAdInOnLogin){
                    Appodeal.show(CosmicFogKryptonite.this, Appodeal.INTERSTITIAL);
                    CosmicFogKryptonite.ShowAdInOnLogin = false;
                }
