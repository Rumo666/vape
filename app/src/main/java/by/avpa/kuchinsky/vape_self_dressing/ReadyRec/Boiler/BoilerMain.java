...
public class BoilerMain extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boiler_main);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("BOILERMAKER");
        GridLayout mainGrid = (GridLayout)findViewById(R.id.boilGrid);
        ...
        Appodeal.setBannerCallbacks(new BannerCallbacks() {
            ...
            public void onBannerLoaded(int height, boolean isPrecache) {
                ...
                if(Appodeal.isLoaded(Appodeal.BANNER)){
                    Appodeal.show(BoilerMain.this, Appodeal.BANNER_BOTTOM);}
            }
            @Override
            ...
            public void onBannerClicked() {
                ...
                Appodeal.hide(BoilerMain.this, Appodeal.BANNER);
            }
        });
    }
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (finalI==0){
                        ...
                        Intent intent = new Intent(BoilerMain.this, Anvil.class);
